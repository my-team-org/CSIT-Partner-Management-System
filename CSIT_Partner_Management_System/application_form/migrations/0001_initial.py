    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.company', verbose_name='ชื่อหน่วยงาน')),
            ],
        ),
        migrations.CreateModel(
            name='HumanResouce',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.company', verbose_name='หน่วยงาน')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('HumanResouce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.humanresouce', verbose_name='ผู้ประสานงาน')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.job', verbose_name='ตำแหน่งงาน')),
            ],
        ),
        migrations.AddField(
            model_name='job',
            name='job_welfare_benefit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.jobbenefit', verbose_name='สวัสดิการ'),
        ),
        migrations.AddField(
            model_name='job',
            name='job_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.jobposition', verbose_name='ชื่อตำแหน่งงาน'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.company')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.job', verbose_name='ตำแหน่งงาน')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_form.student', verbose_name='นิสิต')),
            ],
        ),
    ]
