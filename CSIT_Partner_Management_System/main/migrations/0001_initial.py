    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_posted', models.DateTimeField(auto_now_add=True, verbose_name='วันที่ประกาศงาน')),
                ...
                ('job_department', models.CharField(max_length=255, verbose_name='สาขาวิชา')),
                ('job_file', models.FileField(upload_to='uploads/', verbose_name='ไฟล์แนบ')),
                ('job_status', models.CharField(choices=[('open', 'เปิดรับสมัคร'), ('closed', 'ปิดรับสมัคร')], max_length=50, verbose_name='สถานะ')),
            ],
        ),
        migrations.CreateModel(
            name='Jobbenefit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='logos/', verbose_name='โลโก้บริษัท')),
                ('company_file', models.FileField(blank=True, null=True, upload_to='uploads/', verbose_name='ไฟล์แนบ')),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='managed_companies', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Company_image',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.company', verbose_name='ชื่อหน่วยงาน')),
            ],
        ),
        migrations.CreateModel(
            name='HumanResouce',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.company', verbose_name='หน่วยงาน')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('HumanResouce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.humanresouce', verbose_name='ผู้ประสานงาน')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.job', verbose_name='ตำแหน่งงาน')),
            ],
        ),
        migrations.AddField(
            model_name='job',
            name='job_welfare_benefit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.jobbenefit', verbose_name='สวัสดิการ'),
        ),
        migrations.AddField(
            model_name='job',
            name='job_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.jobposition', verbose_name='ชื่อตำแหน่งงาน'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.job', verbose_name='ตำแหน่งงาน')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.student', verbose_name='นิสิต')),
            ],
        ),
    ]
