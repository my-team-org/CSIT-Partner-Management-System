...
class Jobbenefit(models.Model):
    ...
    def __str__(self):
        return (self.saraly + " " + self.lunch + " " + self.delivery)
...
class Company(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="managed_companies")
    ...
    logo = models.ImageField(upload_to='logos/', blank=True, null=True, verbose_name="โลโก้บริษัท")
    
    company_file = models.FileField(upload_to='uploads/', verbose_name="ไฟล์แนบ", blank=True, null=True)
