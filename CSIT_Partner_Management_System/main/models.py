...
class Job(models.Model):
    ...
    company = models.ForeignKey('Company', on_delete=models.CASCADE, verbose_name="ชื่อหน่วยงาน")  # ชื่อหน่วยงาน
...
class Company(models.Model):
    ...
    logo = models.ImageField(upload_to='static/images/', verbose_name="โลโก้หน่วยงาน")
