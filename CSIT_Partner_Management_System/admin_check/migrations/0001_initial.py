# Generated by Django 5.1.5 on 2025-03-27 06:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.company', verbose_name='ชื่อหน่วยงาน')),
            ],
        ),
        migrations.CreateModel(
            name='HumanResouce',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.company', verbose_name='หน่วยงาน')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('HumanResouce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.humanresouce', verbose_name='ผู้ประสานงาน')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.job', verbose_name='ตำแหน่งงาน')),
            ],
        ),
        migrations.AddField(
            model_name='job',
            name='job_welfare_benefit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.jobbenefit', verbose_name='สวัสดิการ'),
        ),
        migrations.AddField(
            model_name='job',
            name='job_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.jobposition', verbose_name='ชื่อตำแหน่งงาน'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.company')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('student_id', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='รหัสนิสิต')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.student')),
            ],
        ),
        migrations.CreateModel(
            name='Student_job',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.job', verbose_name='ตำแหน่งงาน')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_check.student', verbose_name='นิสิต')),
            ],
        ),
    ]
