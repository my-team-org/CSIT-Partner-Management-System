# Generated by Django 5.1.5 on 2025-03-28 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.company', verbose_name='ชื่อหน่วยงาน')),
            ],
        ),
        migrations.CreateModel(
            name='HumanResouce',
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.company', verbose_name='หน่วยงาน')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('HumanResouce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.humanresouce', verbose_name='ผู้ประสานงาน')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.job', verbose_name='ตำแหน่งงาน')),
            ],
        ),
        migrations.AddField(
            model_name='job',
            name='job_welfare_benefit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.jobbenefit', verbose_name='สวัสดิการ'),
        ),
        migrations.AddField(
            model_name='job',
            name='job_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.jobposition', verbose_name='ชื่อตำแหน่งงาน'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.job', verbose_name='ตำแหน่งงาน')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='review.student', verbose_name='นิสิต')),
            ],
        ),
    ]
